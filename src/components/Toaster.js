...
function Toaster() {
    ...
    return (
        <>
            {toast.show && <div className=" fixed right-10 bottom-10 mt-10 z-30 flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div className="px-4 py-2 -mx-3 flex-grow">
                    <div className="mx-3">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-200">{toast.text}</p>
                    </div>
                </div>
